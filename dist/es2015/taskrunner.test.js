...
test('TaskRunner can run and complete basic tasks', () => {
    let runStartCount = 0;
    let runStartCallback = (taskName) => {
        runStartCount++;
    };
    let runEndCount = 0;
    let runEndCallback = (taskName) => {
        runEndCount++;
    };
    let taskInitCount = 0;
    let taskInitCallback = (task) => {
        taskInitCount++;
    };
    let taskStartCount = 0;
    let taskStartCallback = (task) => {
        taskStartCount++;
    };
    let taskEndCount = 0;
    let taskEndCallback = (task) => {
        taskEndCount++;
    };
    let task1Count = 0;
    let task1 = () => {
...
test('Tasks are run only once even with multiple dependents', () => {
    let runStartCount = 0;
    const runStartCallback = (taskName) => {
        runStartCount++;
    };
    let runEndCount = 0;
    const runEndCallback = (taskName) => {
        runEndCount++;
    };
    let taskInitCount = 0;
    const taskInitCallback = (task) => {
        taskInitCount++;
    };
    let taskStartCount = 0;
    const taskStartCallback = (task) => {
        taskStartCount++;
    };
    let taskEndCount = 0;
    const taskEndCallback = (task) => {
        taskEndCount++;
    };
    let task1Count = 0;
    const task1 = () => {
